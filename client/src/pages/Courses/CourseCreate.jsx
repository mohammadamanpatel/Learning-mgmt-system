        ...
        <HomeLayout>
            <div className="h-[100vh] flex items-center justify-center">
                ...
                <form
                    ...
                    className="flex flex-col justify-center gap-5 rounded-lg p-4 text-white w-full max-w-2xl my-10 shadow-[0_0_10px_black] relative"
                >
                    <Link onClick={() => navigate(-1)} className="absolute top-4 left-4 text-2xl link text-accent cursor-pointer">
                        <AiOutlineArrowLeft />
                    </Link>
                    ...
                    <main className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                        {/* left */}
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex flex-col gap1">
                                ...
                                <textarea
                                    ...
                                    className="bg-transparent px-2 py-1 border h-24 resize-none overflow-y-scroll w-full"
